...
public class ESClientFactory {
    ...
    public void setConnectTimeOutConfig(RestClientBuilder builder){
        builder.setRequestConfigCallback(requestConfigBuilder -> {
            requestConfigBuilder.setConnectTimeout(Integer.valueOf(properties.getProperty(CONNECT_TIME_OUT)));
            requestConfigBuilder.setSocketTimeout(Integer.valueOf(properties.getProperty(SOCKET_TIME_OUT)));
            requestConfigBuilder.setConnectionRequestTimeout(Integer.valueOf(properties.getProperty(CONNECTION_REQUEST_TIME_OUT)));
    ...
    public void setMutiConnectConfig(RestClientBuilder builder){
        builder.setHttpClientConfigCallback(httpClientBuilder -> {
            httpClientBuilder.setMaxConnTotal(Integer.valueOf(properties.getProperty(MAX_CONNECT_NUM)));
            httpClientBuilder.setMaxConnPerRoute(Integer.valueOf(properties.getProperty(MAX_CONNECT_PER_ROUTE)));
            // 长连接保持55s
